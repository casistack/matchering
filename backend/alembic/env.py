"""
Alembic environment configuration for Enhanced Matchering API.

This module configures Alembic to work with our FastAPI application's
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        render_as_batch=True,  # Support for SQLite ALTER operations
    )
...
def run_migrations_online() -> None:
    ...
    if settings.DATABASE_URL.startswith(("postgresql+asyncpg", "sqlite+aiosqlite")):
        ...
        # Fallback to sync mode for sync database URLs
